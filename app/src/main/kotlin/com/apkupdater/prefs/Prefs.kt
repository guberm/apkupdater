...
class Prefs(
	...
	val githubReleaseCache = json("githubReleaseCache", emptyList<com.apkupdater.data.github.GitHubCachedReleases>(), true)
	val githubRetryAt = long("githubRetryAt", 0L, true)
	val githubResumeUntil = long("githubResumeUntil", 0L, true)
